 ...
 */
@WebFilter(filterName = "ProtectPages", urlPatterns = {"/upload.jsp", "/profile.jsp", "/Settings"}, dispatcherTypes = {DispatcherType.REQUEST, DispatcherType.FORWARD, DispatcherType.INCLUDE})
